# Databricks notebook source exported at Sat, 22 Oct 2016 22:17:38 UTC
# MAGIC %md
...
# TODO: Replace <FILL IN> with appropriate code
top15WordsAndCounts = wordCount(shakeWordsRDD).takeOrdered(15, key = lambda (word, kount): -kount)
